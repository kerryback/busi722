...
\item Discontinuous: small rank changes can move a stock between groups, causing unnecessary turnover.
\end{itemize}
\end{frame}
...
\begin{frame}{Exponential Tilts and Softmax}
...
\begin{frame}{Sharpe vs.\ Information Ratio}
\begin{itemize}
