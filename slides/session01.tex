...
\begin{enumerate}
\item Visit \href{https://claude.ai}{claude.ai} and create an account (email or Google/Apple sign-in)
\item After signing in, click ``Upgrade to Pro'' in the sidebar
\item Choose the monthly plan and complete payment
\end{enumerate}

\textbf{2. Watch the setup video:}
\begin{itemize}
\item \href{https://www.youtube.com/watch?v=hpMrTabldEY}{Setup walkthrough} --- covers Node.js, Claude Code, and VS Code installation
\end{itemize}
\end{frame}
...
\begin{frame}{Windows -- Install Claude Code (1/2)}
...
\begin{frame}{Windows -- Install Claude Code (2/2)}
...
Tell Claude Code to install the following packages in the virtual environment:
