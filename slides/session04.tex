...
\alert{If we randomly assign months to train and test, the training set will contain future data relative to some test observations.  The model sees the future before predicting it.}
