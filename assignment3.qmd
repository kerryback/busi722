...
3.  Get adjusted closing prices for SPY, SPYXL, and SPYXS from Yahoo finance and compute daily returns.  
    ...
    (c) Do the relative compound returns (SPYXL to SPY) and (SPYXS to SPY) match the relationship you found in (a)?